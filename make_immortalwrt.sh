...
# 修改路由器 IP 地址
sed -i "s/192.168.1.1/$LAN_IP/g" "$IMMORTALWRT_PATH/package/base-files/files/bin/config_generate"
...
# 进入源目录
cd "$IMMORTALWRT_PATH/bin/targets/x86/64/" || { echo "Source directory not found"; exit 1; }
