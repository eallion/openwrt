...
PACKAGES="$PACKAGES luci-lib-nixio_openssl"
...
PACKAGES="$PACKAGES knot-resolver_dnstap"
...
PACKAGES="$PACKAGES odhcp6c_ext_cer_id=0"
PACKAGES="$PACKAGES odhcpd-ipv6only"
PACKAGES="$PACKAGES odhcpd_ipv6only_ext_cer_id=0"
